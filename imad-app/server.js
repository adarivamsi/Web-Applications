...
var adaris = { 
    ...
    'adari3': {
              title: 'Adari 3 | Adari Vamsi',
              heading: 'Adari 3',
              date: '29 August, 2017',
              content: `
                    <p>
                    This is the content for my third article.  This is the content for my second article. This is the content for my second article. This is the content for my second article. This is the content for my second article. This is the content for my second article. This is the content for my second article. This is the content for my second article. This is the content for my second article.
                    </p>
                    <p>
                    This is the content for my second article.  This is the content for my second article. This is the content for my second article. This is the content for my second article. This is the content for my second article. This is the content for my second article. This is the content for my second article. This is the content for my second article. This is the content for my second article.
                    </p><p>
...
var names=[];
app.get('/submit-name',function(req,res){   //URL: /submit-name?name=vamsi
   //Get the name from the request made by the user
...
app.get('/:adariName', function (req, res){
    var adariName = req.params.adariName;
    res.send(createTemplate(adaris[adariName]));
});
